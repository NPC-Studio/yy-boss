...
use std::path::Path;
use yy_typings::{
    utils::TrailingCommaUtility, AnimationCurve, Extension, Font, Path as YyPath, Sequence, Sound,
    TileSet, Timeline, ViewPath,
};
...
unidentified_resource!(TileSet, "tilesets", Resource::TileSet, tilesets);
